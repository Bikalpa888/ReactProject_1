          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="reveal">
              ...
              <div className="flex flex-wrap items-center gap-4 mt-10">
                ...
                <span className="text-sm" style={{ color: '#9CA3AF' }}>Est. 2016</span>
              </div>
            </div>
            ...
            <div className="liquid-glass rounded-3xl overflow-hidden aspect-[4/5] relative reveal"
              ...
              <div className="absolute bottom-5 left-5 rounded-xl py-3 px-5 shadow-lg"
                ...
                <p className="text-2xl font-black leading-none" style={{ color: '#1F2937' }}>10K+</p>
                <p className="text-xs mt-1" style={{ color: '#6B7280' }}>Happy Customers</p>
              </div>

              {/* 2016 badge */}
              <div className="absolute bottom-5 right-5 rounded-xl py-3 px-5 shadow-lg"
                style={{ background: 'rgba(255,255,255,0.95)', backdropFilter: 'blur(8px)' }}>
                <p className="text-2xl font-black leading-none" style={{ color: '#1F2937' }}>2016</p>
                <p className="text-xs mt-1" style={{ color: '#6B7280' }}>Year Founded</p>
              </div>
            </div>
