...
var require_react_swipe = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	})(exports, function(exports$2, _react, _propTypes) {
		"use strict";
		Object.defineProperty(exports$2, "__esModule", { value: true });
		exports$2.setHasSupportToCaptureOption = setHasSupportToCaptureOption;
...
var require_cssClasses = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.default = {
		ROOT: function ROOT(customClassName) {
			return (0, _classnames.default)(_defineProperty({ "carousel-root": true }, customClassName || "", !!customClassName));
		},
...
var require_dimensions = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.outerWidth = void 0;
	exports.outerWidth = function outerWidth(el) {
...
var require_CSSTranslate = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = void 0;
	exports.default = function _default(position, metric, axis) {
...
var require_Thumbs = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = void 0;
		...
		_createClass(Thumbs, [
				...
				value: function renderItems() {
					...
					return this.props.children.map(function(img, index) {
						var thumbProps = {
							...
							className: _cssClasses.default.ITEM(false, index === _this2.state.selectedItem),
			...
			},
			{
				...
				value: function render() {
					...
					return /*#__PURE__*/ _react.default.createElement("div", { className: _cssClasses.default.CAROUSEL(false) }, /*#__PURE__*/ _react.default.createElement("div", {
...
var require_utils = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.defaultStatusFormatter = function defaultStatusFormatter(current, total) {
	...
	* @param index
	*/
	exports.isKeyboardEvent = function isKeyboardEvent(e) {
	...
	* @param forceReflow
	*/
	exports.getPosition = function getPosition(index, props) {
	...
	exports.setPosition = function setPosition(position, axis) {
		var style = {};
		[
			"WebkitTransform",
			"MozTransform",
...
var require_animations = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	* @param setState
	*/
	exports.slideAnimationHandler = function slideAnimationHandler(props, state) {
		var returnStyles = {};
		var selectedItem = state.selectedItem;
		var previousItem = selectedItem;
		var lastPosition = _react.Children.count(props.children) - 1;
		if (props.infiniteLoop && (selectedItem < 0 || selectedItem > lastPosition)) {
			if (previousItem < 0) if (props.centerMode && props.centerSlidePercentage && props.axis === "horizontal") returnStyles.itemListStyle = (0, _utils.setPosition)(-(lastPosition + 2) * props.centerSlidePercentage - (100 - props.centerSlidePercentage) / 2, props.axis);
	...
	* @param state
	*/
	exports.slideSwipeAnimationHandler = function slideSwipeAnimationHandler(delta, props, state, setState) {
		var returnStyles = {};
	...
	* @param state
	*/
	exports.slideStopSwipingHandler = function slideStopSwipingHandler(props, state) {
		var currentPosition = (0, _utils.getPosition)(state.selectedItem, props);
		return { itemListStyle: (0, _utils.setPosition)(currentPosition, props.axis) };
	};
	exports.fadeAnimationHandler = function fadeAnimationHandler(props, state) {
		var transitionTime = props.transitionTime + "ms";
...
var require_Carousel = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = void 0;
	var _react = _interopRequireWildcard(require_react());
	var _reactEasySwipe = _interopRequireDefault(require_lib());
